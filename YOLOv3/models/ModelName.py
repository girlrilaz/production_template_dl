...
from executor.model_trainer import YOLO
...
class YOLO(BaseModel):
    ...
    def build(self, data_config, filename, model="yolov3-tiny", confidence=0.5):
    ...
    def train(self):
        ...
        # trainer = ModelTrainer(self.model, self.train_dataset, loss, optimizer, metrics, self.epoches)
        # trainer.train()
        pass
